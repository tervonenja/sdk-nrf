...
/* Set define based on if mutexes are defined on the mram1x_controller devicetree node */
#define USING_MRAM_MUTEX DT_NODE_HAS_PROP(DT_NODELABEL(mram1x_controller), nordic_mutexes)
